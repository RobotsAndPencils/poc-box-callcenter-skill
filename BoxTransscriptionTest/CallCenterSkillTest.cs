...
namespace BoxTranscriptionTest
{
    ...
    public class CallCenterSkillTest
    {
        ...
        {
            JObject jsonResult = TestHelper.loadJObject("goodScriptAdherence_CallCenterSkill.GenerateScriptAdherence");
        ...
        {
            JObject jsonResult = TestHelper.loadJObject("goodScriptAdherence_CallCenterSkill.ProcessTranscriptionResults");
            var result = jsonResult.ToObject<BoxTranscriptionLamda.SkillResult>();
